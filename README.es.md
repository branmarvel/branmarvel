...
|-----------------------|------------------|
| **⚽ CeleBreak Profile Task**<br/>Maquetación de perfil móvil premium (estilo de emparejamiento deportivo) siguiendo Clean Architecture, BLoC/Cubit y paridad total en widgets animados.<br/><br/>`Flutter` `Dart` `BLoC/Cubit` `Clean Architecture` `get_it` | [![Repo](https://github-readme-stats.vercel.app/api/pin/?username=branmarvel&repo=profile-CeleBreak-task&theme=tokyonight&hide_border=true&bg_color=0d1117)](https://github.com/branmarvel/profile-CeleBreak-task) |
| **📊 Control y Gestión de Proyectos**<br/>Portal web completo enfocado en la comunidad que facilita la planificación de tareas de extremo a extremo, visualización de Gantt y analíticas potenciadas por Firebase.<br/><br/>`Angular 17` `TypeScript` `Firebase` `dhtmlx-gantt` `CoreUI` | [![Repo](https://github-readme-stats.vercel.app/api/pin/?username=branmarvel&repo=Sistema-para-la-Gestion-y-Control-de-proyectos&theme=tokyonight&hide_border=true&bg_color=0d1117)](https://github.com/branmarvel/Sistema-para-la-Gestion-y-Control-de-proyectos) |
| **📱 Plataforma Educativa AprendeIT (U-Text)**<br/>LMS móvil completo en Flutter con paneles independientes (estudiantes/profesores), creación de pruebas vía Firebase en tiempo real e integración avanzada de ChatGPT-SDK.<br/><br/>`Flutter` `Dart` `Firebase` `ChatGPT SDK` `Provider` | [![Repo](https://github-readme-stats.vercel.app/api/pin/?username=branmarvel&repo=U-text&theme=tokyonight&hide_border=true&bg_color=0d1117)](https://github.com/branmarvel/U-text) |
