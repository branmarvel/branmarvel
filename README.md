...
|-----------------------|------------------|
| **⚽ CeleBreak Profile Task**<br/>Premium mobile sports matchmaking profile page design focusing on custom animated widgets, Clean Architecture, BLoC/Cubit, and strict value equality.<br/><br/>`Flutter` `Dart` `BLoC/Cubit` `Clean Architecture` `get_it` | [![Repo](https://github-readme-stats.vercel.app/api/pin/?username=branmarvel&repo=profile-CeleBreak-task&theme=tokyonight&hide_border=true&bg_color=0d1117)](https://github.com/branmarvel/profile-CeleBreak-task) |
| **📊 Project Control & Management**<br/>Complete community-focused web portal facilitating end-to-end task planning, Gantt visualization, and Firebase-powered analytics.<br/><br/>`Angular 17` `TypeScript` `Firebase` `dhtmlx-gantt` `CoreUI` | [![Repo](https://github-readme-stats.vercel.app/api/pin/?username=branmarvel&repo=Sistema-para-la-Gestion-y-Control-de-proyectos&theme=tokyonight&hide_border=true&bg_color=0d1117)](https://github.com/branmarvel/Sistema-para-la-Gestion-y-Control-de-proyectos) |
| **📱 AprendeIT LMS App (U-Text)**<br/>Full-featured mobile learning management system (LMS) with student/faculty dashboards, real-time Firebase quiz creation, and a built-in ChatGPT assistant module.<br/><br/>`Flutter` `Dart` `Firebase` `ChatGPT SDK` `Provider` | [![Repo](https://github-readme-stats.vercel.app/api/pin/?username=branmarvel&repo=U-text&theme=tokyonight&hide_border=true&bg_color=0d1117)](https://github.com/branmarvel/U-text) |
